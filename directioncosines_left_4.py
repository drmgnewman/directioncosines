...
def main():
    ...
    for k in range(1, nt + 1, 1):
        for j in range(1, ns // nt + 1, 1):
            ...
            bomega[1] = bomegaj[1] + deltat * fomega1[1] / 2.0
            bomega[2] = bomegaj[2] + deltat * fomega1[2] / 2.0
            bomega[3] = bomegaj[3] + deltat * fomega1[3] / 2.0
            bi = [0.0, o[1][1], o[2][1], o[3][1]]
            bj = [0.0, o[1][2], o[2][2], o[3][2]]
            bk = [0.0, o[1][3], o[2][3], o[3][3]]
            bgbi = bg[1] * bi[1] + bg[2] * bi[2] + bg[3] * bi[3]
            ...
            bomega[1] = bomegaj[1] + deltat * fomega2[1] / 2.0
            bomega[2] = bomegaj[2] + deltat * fomega2[2] / 2.0
            bomega[3] = bomegaj[3] + deltat * fomega2[3] / 2.0
            bi = [0.0, o[1][1], o[2][1], o[3][1]]
            bj = [0.0, o[1][2], o[2][2], o[3][2]]
            bk = [0.0, o[1][3], o[2][3], o[3][3]]
            bgbi = bg[1] * bi[1] + bg[2] * bi[2] + bg[3] * bi[3]
            ...
            bomega[1] = bomegaj[1] + deltat * fomega3[1]
            bomega[2] = bomegaj[2] + deltat * fomega3[2]
            bomega[3] = bomegaj[3] + deltat * fomega3[3]
            bi = [0.0, o[1][1], o[2][1], o[3][1]]
            bj = [0.0, o[1][2], o[2][2], o[3][2]]
            bk = [0.0, o[1][3], o[2][3], o[3][3]]
            bgbi = bg[1] * bi[1] + bg[2] * bi[2] + bg[3] * bi[3]
            ...
            bomega[1] = bomegaj[1] + deltat * (fomega1[1] + 2.0 * fomega2[1] + 2.0 * fomega3[1] + fomega4[1]) / 6.0
            bomega[2] = bomegaj[2] + deltat * (fomega1[2] + 2.0 * fomega2[2] + 2.0 * fomega3[2] + fomega4[2]) / 6.0
            bomega[3] = bomegaj[3] + deltat * (fomega1[3] + 2.0 * fomega2[3] + 2.0 * fomega3[3] + fomega4[3]) / 6.0
            bi = [0.0, o[1][1], o[2][1], o[3][1]]
            bj = [0.0, o[1][2], o[2][2], o[3][2]]
            bk = [0.0, o[1][3], o[2][3], o[3][3]]
            bgbi = bg[1] * bi[1] + bg[2] * bi[2] + bg[3] * bi[3]
